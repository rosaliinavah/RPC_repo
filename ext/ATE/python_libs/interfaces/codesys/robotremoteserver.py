"""
Not my code and Codesys using IronPython 2.7 so...
"""
# pylint:disable=consider-using-f-string, invalid-name, deprecated-method, undefined-variable, deprecated-class, broad-exception-caught
# pylint:disable=unused-argument, missing-function-docstring,missing-class-docstring, missing-module-docstring, useless-object-inheritance
# pylint:disable=unspecified-encoding, too-many-arguments, redefined-outer-name, too-few-public-methods, raise-missing-from
