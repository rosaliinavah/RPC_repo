...
PLCOPEN_XML=u"C:\\Codesys RPC\\apps\\CodesysRPC\\EPEC_CU2\\EPEC_CU2_simulation.xml"
APPLICATION_GUID="639b491f-5557-464c-af91-1471bac9f549"
LIBRARY_MANAGER_GUID="adb5cb65-8e1d-4a00-b70a-375ea27582f3"
APPLICATIONERRORSENUM=u"C:\\Program Files (x86)\\Epec\\MultiTool Creator 8.6\\Resources\\Config\\ProjectTemplates\\ApplicationErrorsEnum.xml"
NEW_DEVICE_TARGET_ID="10C8 802C"
SAFETY_PLC_TYPE=4098
CHANGE_UNIT_SAFETYMAIN_XML=u"C:\\Program Files (x86)\\Epec\\MultiTool Creator 8.6\\Resources\\Config\\ProjectTemplates\\PLCopenTemplate_ChangeUnit_SafetyMain.xml"
CHANGE_UNIT_FASTPARAMETERS_XML=u"C:\\Program Files (x86)\\Epec\\MultiTool Creator 8.6\\Resources\\Config\\ProjectTemplates\\PLCopenTemplate_ChangeUnit_FastParameters.xml"
...
LIBRARIES=[
    ('CANL2 CANVXD', 'EPEC_CANL2', '4.2.0.0', 'Epec Oy'),
    ('SafeCORE1_01_B_MCUint', 'EPEC_HW', '0.0.0.1', 'Epec Oy'),
    ('SafeSSeriesIoDriverExt', 'EPEC_IODRV', '1.0.0.14', 'Epec Oy'),
    ('SSeriesCanExt', 'EPEC_CANEXT', '1.0.0.1', 'Epec Oy'),
    ('SSeriesNvRamExt', 'EPEC_NVRAM', '1.0.0.4', 'Epec Oy'),
    ('SSeriesSystemExt', 'EPEC_SYSTEM', '1.0.0.17', 'Epec Oy'),
    ('SSeriesHardware', 'EPEC_HWD', '1.1.6.0', 'Epec Oy'),
    ('CANVXD API', 'EPEC_CANVXD', '4.0.0.1', 'Epec Oy'),
    ('DiagnosticInterface2', 'EPEC_DITF', '2.0.0.1', 'Epec Oy'),
    ('Safe S Series Hardware', 'EPEC_SHWD', '2.0.4.0', 'Epec Oy'),
    ('Safe CANopen SRDO', 'EPEC_SRDO', '2.0.0.1', 'Epec Oy'),
    ('Safe Conversion', 'EPEC_SC', '2.0.0.2', 'Epec Oy'),
    ('Safe Data Validation', 'EPEC_SDV', '2.0.0.2', 'Epec Oy'),
    ('Safe Joystick Calibration And Diagnostic', 'EPEC_SJCD', '2.0.0.1', 'Epec Oy'),
    ('Safe Proportional Valve Control', 'EPEC_SPVC', '2.0.0.2', 'Epec Oy'),
    ('Safe Sensor Calibration', 'EPEC_SSCD', '2.0.0.2', 'Epec Oy'),
    ...
    ('SAE J1939', 'EPEC_J1939', '3.2.0.2', 'Epec Oy'),
    ('J1939 To Event Translator', 'EPEC_J1939Event', '3.0.2.2', 'Epec Oy'),
    ('SafeErrorLog', 'EPEC_SERRLOG', '2.0.1.0', 'Epec Oy'),
    ('AddressClaiming', 'EPEC_ACL', '1.0.1.0', 'Epec Oy'),
    ('J1939DM', 'EPEC_J1939DM', '1.0.0.3', 'Epec Oy'),
    ('Sensors And Actuators', 'EPEC_SA', '2.0.2.0', 'Epec Oy'),
    ('Safe CORE MCU Diagnostic', 'EPEC_HWDIAG', '2.0.0.0', 'Epec Oy'),
    ('MachineType', 'EPEC_MachineType', '1.0.0.2', 'Epec Oy'),
    ('SAE J1939 Safety', 'EPEC_SJ1939', '2.0.0.15', 'Epec Oy'),
    ('SafeHBridgeControl', 'EPEC_SHB', '2.0.0.7', 'Epec Oy'),
...
MAPPED_IO_VARIABLES = [ ('Application.S_Inputs.AI_VIN_V_Diagnostic', 204290), ('Application.S_Inputs.AI_PCB_1_V_Diagnostic', 202754), ('Application.S_Inputs.AI_PCB_2_V_Diagnostic', 203010), ('Application.S_Inputs.AI_MCU_C_Diagnostic', 203275), ('Application.S_Inputs.AI_SBC_C_Diagnostic', 203531), ('Application.S_Inputs.AI_VOUT_SAFE_Diagnostic', 203778), ('Application.S_Inputs.AI_VOUT_NON_SAFE_Diagnostic', 204034), ('Application.S_Inputs.AI_BSL_V_Diagnostic', 204546), ('Application.S_Inputs.DI_FACTORY_RESET_Diagnostic', 393482), ('Application.S_Inputs.DI_SERVICE_MODE_Diagnostic', 393738), ('Application.S_Outputs.TotalOutputCurrent_Diagnostic', 13107209),]
...
def main(project):
    ...
    if device.is_device:
        ...
        device.update(4096, "10C8 802C", "3.5.19.20")
