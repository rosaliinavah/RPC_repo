...
PLCOPEN_XML=u"C:\\Codesys RPC\\apps\\CodesysRPC\\EPEC_CU3\\EPEC_CU3_simulation.xml"
...
NEW_DEVICE_TARGET_ID="10C8 8040"
...
LIBRARIES=[
    ('CoreBootApplication', 'EPEC_CoreBootApp', '3.5.19.0', 'Epec Oy'),
    ('CoreUsbDrive', 'EPEC_COREUSB', '3.5.19.0', 'Epec Oy'),
    ('CoreSystemParameters', 'EPEC_CORESPRM', '3.5.19.1', 'Epec Oy'),
    ('CoreSocketCAN', 'EPEC_CoreSocketCAN', '3.5.19.0', 'Epec Oy'),
    ('CoreCANVXD', 'EPEC_CoreCANVXD', '1.0.0.2', 'Epec Oy'),
    ('CoreInt', 'EPEC_HW', '1.0.0.2', 'Epec Oy'),
    ('OS Library 2', 'EPEC_OSLIB2', '3.5.16.0', 'Epec Oy'),
    ('CANopen', 'EPEC_CANopen', '4.1.0.1', 'Epec Oy'),
    ('CANopen OD Save', 'EPEC_ODSave', '4.0.1.1', 'Epec Oy'),
    ('CANVXD API2', 'EPEC_CANVXD', '1.0.0.0', 'Epec Oy'),
    ('Parameter Handler', 'EPEC_PH', '1.0.2.4', 'Epec Oy'),
    ('SAE J1939', 'EPEC_J1939', '3.3.0.3', 'Epec Oy'),
    ('AddressClaiming', 'EPEC_ACL', '1.1.0.0', 'Epec Oy'),
    ('J1939DM', 'EPEC_J1939DM', '1.1.0.0', 'Epec Oy'),
...
def main(project):
    ...
    if device.is_device:
        ...
        device.update(4096, "10C8 8040", "3.5.19.3")
